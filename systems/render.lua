...
local renderer = tiny.system {
	...
	-- shadow_map = l3d.new_shadow_map(512, 512),
	-- shadow_map = l3d.new_shadow_map(1024, 1024),
	shadow_map = l3d.new_shadow_map(2048, 2048),
	-- shadow_map = l3d.new_shadow_map(4096, 4096),
...
function renderer:draw(entity, shader)
